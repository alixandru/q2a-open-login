...
return array(
	...
	'merge_accounts_note' => 'Important! The selected logins will be associated with your current profile and their initial profiles will be permanently deleted. Reputation points linked belonging to these profiles will not be migrated, and previous activity will be marked as annonymous.',
	'split_accounts' => 'Disconnect selected accounts',
	'split_accounts_note' => 'Note: once disconnected, your profile will not be associated with those accounts. When you will sign in again with those login IDs, separate user accounts will be assigned to them. You can however merge them again with your current profile if you want.',
